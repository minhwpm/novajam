        ...
        <form className="flex flex-col gap-3 mt-5">
          ...
          <fieldset>
            <input
              ...
              type="checkbox"
            />
            <label htmlFor="policyAgree" className="ml-3 text-sm">
              I agree to <Link className="text-blue-600 hover:underline" href="/terms">Terms & Conditions</Link> and <Link className="text-blue-600 hover:underline" href="/privacy-policy">Privacy Policy</Link>
            </label>
          </fieldset>
          ...
          <p className="mt-4 text-center">
            Already have an account? <Link className="text-blue-600 hover:underline" href="/login">Log in</Link>
          </p>
        </form>
      </div>
    </main>
